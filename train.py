...
if __name__ == "__main__":
    ...
    scaled = pd.read_csv("data/merged.csv") ## read the model ready data here
    ...
    train_x = train.drop(['fulfillment'], axis=1)
    test_x = test.drop(['fulfillment'], axis=1)
    train_y = train[['fulfillment']]
    test_y = test[['fulfillment']]
